...
class ImpedanceConfigProcessor(): 
    ...
    def process_stressors(self, current_dir:str, stressor_dir:str, config_dir:str, use_lulc_pa:bool) -> dict:
        """
        ...
        self.impedance_stressors, self.config_impedance = lip.update_impedance_config(use_lulc_pa)
